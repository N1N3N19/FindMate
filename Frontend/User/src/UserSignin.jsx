        ...
        <div>
            <div className="bg-white border border-amber-400 rounded-lg p-10 w-96 box-border shadow-lg backdrop-filter backdrop-blur-lg relative transition-all duration-200">
                ...
                <div className="relative my-4">
                    <input type="email" className="rounded-full w-full py-2.5 pl-5 px-0 mt-1 text-sm text-neutral-500 bg-gray-100 bg-opacity-80 appearance-none focus:outline-none focus:ring-0 focus:text-neutral-500 focus:border-amber-400 peer" placeholder="" onChange={handleUsernameInput} />
                ...
                <div className="relative my-4 text-center">
                    <Link className="text-neutral-500" to='/userSignup'><u>Forgot your password?</u></Link>
                </div>
                </form>
            </div>
        </div>
